...
config.NETWORK.RESOLUTION = [120, 360, 2]
config.NETWORK.BOUNDS = [480, 1440, 200]
...
config.DATASET.TRANSLATION_SCALE = 1
config.DATASET.IMAGE_SIZE = [1080, 1920]
config.DATASET.WORLDGRID = [480, 1440, 800]
config.DATASET.ORIGINAL_SIZE = [2160, 3840]
